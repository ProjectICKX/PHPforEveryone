...
namespace project_ickx\php_for_everyone\streams\filters\utilitys\entitys;
...
class StreamFilterSpecEntity
{
     ...
     *  ]
     * @return  \project_ickx\php_for_everyone\streams\filters\utilitys\StreamFilterSpec    このインスタンス
     */
     ...
     * このインスタンスを複製し返します。
     *
     * @return  \project_ickx\php_for_everyone\streams\filters\utilitys\StreamFilterSpec    複製されたこのインスタンス
     */
     ...
     * @return  string|\SplFileInfo|\SplFileObject|\project_ickx\php_for_everyone\streams\filters\utilitys\StreamFilterSpec フィルタの対象となるストリームまたはこのインスタンス
     */
     ...
     * @return  array|\project_ickx\php_for_everyone\streams\filters\utilitys\StreamFilterSpec  書き込みチェーンに適用するフィルタのリストまたはこのインスタンス
     */
     ...
     * @return  array|\project_ickx\php_for_everyone\streams\filters\utilitys\StreamFilterSpec  読み込みチェーンに適用するフィルタのリストまたはこのインスタンス
     */
     ...
     * @return  array|\project_ickx\php_for_everyone\streams\filters\utilitys\StreamFilterSpec  書き込みチェーン、読み込みチェーン双方に適用するフィルタのリストまたはこのインスタンス
     */
